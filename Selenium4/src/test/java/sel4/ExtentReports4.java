...
import com.aventstack.extentreports.reporter.configuration.Theme;
	...
	public class ExtentReports4 {
		...
		public void startReport() 
		{
			...
			extent.setSystemInfo("User Name", "Binay Kr");
			htmlReporter.config().setDocumentTitle("Title of the Report:TestNG ExtentReports"); 
	                // Name of the report
			htmlReporter.config().setReportName("Name of the Report:ExtentReports4"); 
	                // Dark Theme
